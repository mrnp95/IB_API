...
class TestApp(TestWrapper, TestClient):
    ...
    def tickPrice(self, reqId: TickerId, tickType: TickType, price: float,
        ...
        with open('Price.csv', 'a') as log1:
            log1.write(str(tickType) + '\t' + str(price) + '\n')
        #print("------------", type(price))
        # a = []
        # a.append(price)
        # np.savetxt(a,'Price.txt')
    ...
    def tickSize(self, reqId: TickerId, tickType: TickType, size: int):
        ...
        with open('Size.csv', 'a') as log2:
            log2.write(str(tickType) + '\t' + str(size) + '\n')
    # ! [ticksize]
    ...
    def tickGeneric(self, reqId: TickerId, tickType: TickType, value: float):
        ...
        with open('Value_Gen.csv', 'a') as log3:
            log3.write(str(tickType) + '\t' + str(value) + '\n')
    # ! [tickgeneric]
    ...
    def tickString(self, reqId: TickerId, tickType: TickType, value: str):
        ...
        with open('Value_Str.csv', 'a') as log4:
            log4.write(str(tickType) + '\t' + str(value) + '\n')
    # ! [tickstring]
